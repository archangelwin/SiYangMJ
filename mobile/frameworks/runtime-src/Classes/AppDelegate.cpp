...
bool AppDelegate::applicationDidFinishLaunching()
{
...
#if CC_TARGET_PLATFORM != CC_PLATFORM_WIN32
    #if CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID
    	CrashReport::initCrashReport("8bed3dcefa", isDebug);
    #elif CC_TARGET_PLATFORM == CC_PLATFORM_IOS
    	CrashReport::initCrashReport("cb8dd04403", isDebug);
    #endif    
	...
	stack->setXXTEAKeyAndSign("RY_QP_caonima18_!2016", strlen("RY_QP_caonima18_!2016"), "RY_ccc_2016", strlen("RY_ccc_2016"));
