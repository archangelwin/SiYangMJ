...
public class ThirdDefine {
	...
	//appid
	public static String  WeixinAppID  = "wx3c93e6fa6c32bffe";
	//secret
	public static String WeixinAppSecret = "c0583c90ccae6bc7e07e5b25d2328ab5";	
	//商户id
	...
	//分享链接
	public static String  ShareURL = "http://www.jiuhuogame.com";
	//分享标题
	public static String   ShareTitle = "泗阳欢喜麻将";
	//分享内容
	public static String   ShareContent = "泗阳欢喜麻将http://www.jiuhuogame.com";
