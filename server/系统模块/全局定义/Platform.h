...
//平台常量
const TCHAR szProduct[]=TEXT("福乐游戏");							//产品名字
const TCHAR szPlazaClass[]=TEXT("RYQPGamePlaza");						//广场类名
const TCHAR szProductKey[]=TEXT("RYQPGamePlatform");					//产品主键

//地址定义
const TCHAR szCookieUrl[]=TEXT("http://192.168.1.88:8080");					//记录地址
const TCHAR szLogonServer[]=TEXT("192.168.1.88");						//登录地址
const TCHAR szPlatformLink[]=TEXT("http://192.168.1.88:8080");				//平台网站
