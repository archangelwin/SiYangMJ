...
#define CHR_PING_HU					0x00000002							//平胡
...
struct tagAnalyseZaPai
{
	BYTE							cbCardCount[7];						//杂牌个数
};
...
public:
	...
	//听牌分析 机器人使用
	BYTE AnalyseTingCard(const BYTE cbCardIndex[MAX_INDEX], const tagWeaveItem WeaveItem[], BYTE cbWeaveCount, DWORD dwChiHuRight);
