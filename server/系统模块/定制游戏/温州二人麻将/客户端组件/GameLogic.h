...
public:
  //分析字牌
  void AnalyseZiCard(BYTE cbCardIndex[MAX_INDEX], BYTE cbZiCardData[7], BYTE &cbZiCardCount);
  //分析风牌和箭牌张数
  void AnalyseFengAndJianCardCount(BYTE cbCardData[7], BYTE &cbFengCardCount, BYTE &cbJianCardCount);
  //判断是否风牌
  bool IsFengCard(BYTE cbCardData);
  //判断是否箭牌
  bool IsJianCard(BYTE cbCardData);
};
