...
// 	}
	...
	if (m_CustomRule.cbMaxZui < 0 || m_CustomRule.cbMaxZui > 8)
	{
		AfxMessageBox(TEXT("嘴范围错误，请重新设置！"), MB_ICONSTOP);
		return false;
	}

	if (m_CustomRule.cbScoreZui < 2 || m_CustomRule.cbScoreZui > 8)
	{
		AfxMessageBox(TEXT("嘴分数范围错误，请重新设置！"), MB_ICONSTOP);
		return false;
	}
