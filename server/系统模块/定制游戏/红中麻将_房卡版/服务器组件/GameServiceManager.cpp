...
#include "tbl/table_mgr.h"

//////////////////////////////////////////////////////////////////////////////////

//机器定义
#ifndef _DEBUG
	#define ANDROID_SERVICE_DLL_NAME	TEXT("SparrowHZAndroidService.dll")	//组件名字
#else
	#define ANDROID_SERVICE_DLL_NAME	TEXT("SparrowHZAndroidService.dll")	//组件名字
#endif
...
bool CGameServiceManager::RectifyParameter(tagGameServiceOption & GameServiceOption)
{
	...
	if (pCustomRule->cbMaxZui < 0 || pCustomRule->cbMaxZui > 8)
	{
		pCustomRule->cbMaxZui = 0;
	}

	if (pCustomRule->cbScoreZui < 2 || pCustomRule->cbScoreZui > 8)
	{
		pCustomRule->cbScoreZui = 2;
	}
