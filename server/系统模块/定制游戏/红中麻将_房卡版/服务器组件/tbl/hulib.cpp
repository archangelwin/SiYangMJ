...
bool HuLib::get_hu_info(char* const hand_cards, Wave* const waves, char self_card, char other_card, int gui_index, bool other_gui)
{
	...
	int gui_num = 0;
	if (gui_index < MAX_INDEX)
	{
		if (other_gui)
		{
			gui_num = hand_cards_tmp[gui_index] - 1;
			hand_cards_tmp[gui_index] = 1;
		}
		else
		{
